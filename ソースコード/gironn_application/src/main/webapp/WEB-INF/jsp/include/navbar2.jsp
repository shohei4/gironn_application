...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="${root_path }/GironnList?flag=top&gidaiId=${gidaiId}">コメント一覧 <span class="sr-only">(current)</span></a>
      </li>
    ...
    <form class="form-inline my-2 my-lg-0" action="${root_path}/GironnList" method="get">
      <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" name="key" id="key" value="${key}">
       <input type="hidden" name="gidaiId" value="${gidaiId}">
